...
<div id="gaia-gate-modal" role="dialog" aria-modal="true" aria-labelledby="gaia-gate-header-title">
  <div id="gaia-gate-box">
    <div id="gaia-gate-header">
      <div>
        <div id="gaia-gate-header-title">Download GAIA Data</div>
    ...
    <div id="gaia-gate-body">
      ...
      <form id="gaia-gate-form" novalidate>
        ...
        <p class="gate-note">Your information helps us track GAIA's impact. We will not spam you.</p>
        <button type="submit" id="gaia-gate-submit">Download →</button>
...
`;
  ...
  function init() {
    ...
    document.addEventListener('click', function (e) {
      ...
      // Already registered this session — download directly
    ...
    function openModal(fileUrl) {
      ...
      setTimeout(() => form.querySelector('[name="email"]').focus(), 50);
    }
